...
# Safe browser-driven auto refresh every 30 seconds (Eliminates CPU Throttling)
st_autorefresh(interval=30 * 1000, key="radar_auto_refresh")
...
# ------------------------------------------------------------------
# 6. LIVE SCANNER ENGINE (SINGLE EXECUTION PER BROWSER INTERVAL)
# ------------------------------------------------------------------
results = []
